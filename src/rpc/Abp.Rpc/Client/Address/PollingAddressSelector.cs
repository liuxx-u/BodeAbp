...
namespace Abp.Rpc.Client.Address
{
    ...
    public class PollingAddressSelector : AddressSelectorBase
    {
        ...
        protected override async Task<AddressBase> SelectAsync(AddressSelectContext context)
        {
        ...
        protected class AddressEntry
        {
            ...
            private readonly AddressBase[] _address;

            #endregion Field

            #region Constructor

            public AddressEntry(IEnumerable<AddressBase> address)
            {
