...
namespace BodeAbp.Queue.Broker.Storage
{
    public unsafe class Chunk : IDisposable
    {
        ...
        private static readonly ILogger _logger = IocManager.Instance.Resolve<ILoggerFactory>().Create(typeof(Chunk));
        private static readonly IChunkStatisticService _chunkStatisticService = IocManager.Instance.Resolve<IChunkStatisticService>();
