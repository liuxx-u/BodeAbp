...
namespace Abp.Web.Localization
{
    internal class LocalizationScriptManager : ILocalizationScriptManager, ISingletonDependency
    {
        ...
        public LocalizationScriptManager(ILocalizationManager localizationManager, ILanguageManager languageManager, ICacheManager cacheManager)
        {
        ...
        {
            //NOTE: Disabled caching since it's not true (localization script is changed per user, per culture...)
