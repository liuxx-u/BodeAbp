...
using WebDemo.Web.Controllers.Results;
using WebDemo.Web.Models.Account;
...
{
    public class AccountController : WebDemoControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = WebDemo.Authorization.Users.User.CreateRandomPassword();
